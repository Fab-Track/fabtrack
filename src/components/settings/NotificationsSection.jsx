...
const SHOP_TRIGGERS = [
  ...
  { id: "install_scheduled", label: "Install scheduled", sms: false, email: true, who: ["Shop Manager", "Installer"] },
  { id: "install_reminder", label: "Install day reminder (auto — 8 AM day before)", sms: true, email: true, who: ["Customer", "Installer"] },
...
const PERSONAL_TRIGGERS = [
  ...
  { id: "install_scheduled", label: "Install scheduled", roles: ["shop_manager", "installer"] },
